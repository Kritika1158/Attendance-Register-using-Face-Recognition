...
class App:
    def __init__(self):
        ...
        self.main_window.geometry("1100x520+200+100")
    ...
    def login(self):
        ...
        label = test(
            ...
            model_dir=r'C:\Users\KRITIKA\PycharmProjects\faceRec\Silent-Face-Anti-Spoofing-master\resources\anti_spoof_models',
            # path_components=['C:', 'Users', 'KRITIKA', 'PycharmProjects', 'faceRec', 'Silent-Face-Anti-Spoofing-master',
            #                  'resources', 'anti_spoof_models'],
            # model_dir=os.path.join(*path_components),
            device_id=0
        )
    ...
    def logout(self):
        ...
        label = test(
            image=self.most_recent_capture_arr,
            # model_dir=os.path.join(r'C:', 'Users', 'KRITIKA', 'PycharmProjects', 'faceRec', 'Silent-Face-Anti-Spoofing-master', 'resources', 'anti_spoof_models'),
            model_dir=r'C:\Users\KRITIKA\PycharmProjects\faceRec\Silent-Face-Anti-Spoofing-master\resources\anti_spoof_models',
            # path_components=['C:', 'Users', 'KRITIKA', 'PycharmProjects', 'faceRec', 'Silent-Face-Anti-Spoofing-master',
            #                  'resources', 'anti_spoof_models'],
            # model_dir= os.path.join(*path_components),
